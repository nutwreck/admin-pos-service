...
type ProductCategorySub struct {
	...
	ProductCategoryID string `json:"product_category_id" validate:"required,uuid" example:"9e769a02-0214-4277-90d0-bdf7f7b7c064"`
	// Input with Lowercase
	Name    string `json:"name" validate:"required,lowercase,max=200" example:"goreng"`
...
type GetProductCategorySub struct {
	ID                  string    `json:"id"`
...
type ProductCategorySubRequest struct {
	MerchantID        string `json:"merchant_id" validate:"required,uuid" example:"81c0b615-d575-4d30-a81a-6b8db70fd4e0"`
	OutletID          string `json:"outlet_id" validate:"required,uuid" example:"4e769a02-0214-4277-90d0-bdf7f7b7c064"`
	ProductCategoryID string `json:"product_category_id" validate:"required,uuid" example:"9e769a02-0214-4277-90d0-bdf7f7b7c064"`
	// Input with Lowercase
