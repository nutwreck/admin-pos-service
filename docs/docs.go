...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/master/mapping-role-menu-user/create": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "Create Mapping Role Menu User",
                        "name": "mappingrolemenuuser",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/schemes.MappingRoleMenuUserRequest"
                            }
                        }
                    }
                ],
        ...
        "/api/v1/master/mapping-role-menu-user/delete": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Delete Mapping Role Menu User",
                        "name": "id",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/master/mapping-role-menu-user/results": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Use ASC or DESC | Available column sort : mappingrolemenuuser.id, merchant.id, merchant.name, user.id, user.name, mappingrolemenu.id, mappingrolemenu.name, mappingrolemenuuser.created_at, default is mappingrolemenuuser.created_at DESC | If you don't want to use it, fill it blank",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/master/mapping-role-menu-user/update": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Update Mapping Role Menu User",
                        "name": "id",
                        "in": "query",
                        "required": true
                    },
        ...
        "/api/v1/master/mapping-role-menu/create": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "Create Mapping Role Menu",
                        "name": "mappingrolemenu",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemes.MappingRoleMenuRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/master/mapping-role-menu/delete": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Delete Mapping Role Menu",
                        "name": "id",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/master/mapping-role-menu/results": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Use ASC or DESC | Available column sort : mappingrolemenu.id, mappingrolemenu.name, mappingrolemenu.active, mappingrolemenu.created_at, merchant.id, merchant.name, role.id, role.name, menu.id, menu.name, menudetail.id, menudetail.name, menudetailfunction.id, menudetailfunction.name, default is mappingrolemenu.created_at DESC | If you don't want to use it, fill it blank",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/master/mapping-role-menu/update": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Update Mapping Role Menu",
                        "name": "id",
                        "in": "query",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "schemes.MappingRoleMenuRequest": {
            "type": "object",
            "required": [
                "menu_detail_function_id",
                "menu_detail_id",
                "menu_id",
                "merchant_id",
                "name",
        ...
        "schemes.MappingRoleMenuUserRequest": {
            "type": "object",
            "required": [
                "mapping_role_menu_id",
                "merchant_id",
                "user_id"
            ],
            "properties": {
